...
### 1.2 The Heavy Hitters Problem {#sec1-2}
...
### 1.4 The Approximate Heavy Hitters Problem {#sec1-4}
...
![cms](/cs168/images/l2/cms.jpg){:height="60%" width="60%" style="display:block;margin:auto;"}
{: #fig1}

*Figure 1: Running Inc$$(x)$$ on the CMS data structure. Each row corresponds to a hash function $$h_i$$.*
...
###  2.4 Count-Min Sketch: Heuristic Error Analysis {#sec2-4}
...
### 2.5 Count-Min Sketch: Rigorous Error Analysis {#sec2-5}
