...
**Fact 1.1** \label{fact:hh}
*There is *no* algorithm that solves the Heavy Hitters problems in one pass
while using a sublinear amount of auxiliary space.*

We next explain the intuition behind Fact \ref{fact:hh}.  We encourage
