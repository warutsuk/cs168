...
\underbrace{|x_1|x_2|x_3|\cdots|x_{n-1}|}_{\text{set $$S$$ of distinct elements}}y|,
\end{equation}
$$
...
$$S$$ to answer queries of the form "is $$y \in S$$"?  
(A hash table is the most common solution to this problem.)
